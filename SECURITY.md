...
本文档汇总了 **智能多Web应用门户系统 V2.0** 的所有安全相关配置选项。
...
| 版本 | 日期 | 更新内容 |
|------|------|----------|
| v2.0 Phase 3 | 2025-01 | filesystem 硬化、CORS 收敛、审计日志 |
| v2.0 Phase 2 | 2025-01 | 会话撤销、Token 黑名单、审计日志服务 |
| v2.0 Phase 1 | 2025-01 | 统一 RBAC 中间件、JWT 生产环境强制配置 |
